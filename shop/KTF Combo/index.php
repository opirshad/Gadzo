                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body"><B>
							<h1 id="product-title" class="h2">GADZO NON STICK KTF 22,22,24 2MM IB -IGZKTF 22, 22, 24 IB</h1></B>
							<p id="product-price" class="h3 py-2">₹ 2999</p>
                            <p class="py-2">
                            ...
                            <h6>Gadzo KTF COMBO</h6>
                            <p>KTF Combo! Perfect for home</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Kadai , Tawa , Fry pan Included</h6>
                                </li>
                                <li class="list-inline-item">
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>High Quality Alluminium</li>
                                <li>Sturdy Ergonomic Handle</li>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
											...
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="GADZO NON STICK KTF 22,22,24 2MM IB -IGZKTF 22, 22, 24 IB" data-price="2999">22,22,24</span>
											</li>
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="GADZO NON STICK KTF 24,25,24  2MM -IGZKTF 24, 25, 24" data-price="3499">24,25,24</span>
											</li>
