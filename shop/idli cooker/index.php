                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body"><B>
							<h1 id="product-title" class="h2">GADZO SS IDLI STEAMER WITH 4 PLATE -GZMH 4PL
</h1></B>
                            ...
                            <h6>Idli Cooker</h6>
                            <p>Steam Fresh, Soft & Fluffy Idlis Every Time</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Avaliable Color :</h6>
                                </li>
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>Steel Finish</strong></p>
                                </li>
                            </ul>

                            <h6>Specification:</h6>
                            <ul class="list-unstyled pb-3">
                                <li>0.5 MM Body Thickness</li>
                                <li>Strong & Sturdy Heat resistant handles</li>
                                <li>Can be used on induction and gas stoves</li>
                                <li>Gray Coating</li>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
											...
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="GADZO SS IDLI STEAMER WITH 4 PLATE -GZMH 4PL" data-price="1699">4 plate</span>
											</li>
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="GADZO SS IDLI STEAMER WITH 6 PLATE -GZMH 6PL" data-price="1899">6 plate</span>
											</li>
