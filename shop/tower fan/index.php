                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body"><B>
							<h1 id="product-title" class="h2">GADZO TOWER FAN - GZ SPTF2</h1></B>
							<p id="product-price" class="h3 py-2">₹ 4299
                            <p class="py-2">
                            ...
                            <h6>Tower Fan</h6>
                            <p>Premium Tower Fan for Perfect Breaze! Perfect for home</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>Shock Proof</li>
                                <li>Rest Free Body</li>
                                <li>Auto Air Swing</li>
                                <li>Supeerior Air Throw</li>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
											...
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="GADZO TOWER FAN - GZ SPTF2" data-price="4299">Normal</span>
											</li>
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="GADZO TOWER FAN PRIME - GZ SPTFP1" data-price="4799">Prime</span>
											</li>
                                        </ul>
                                    </div><!-- Close Content 
                                    <div class="col-auto">
