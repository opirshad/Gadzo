...
echo "<link rel='stylesheet' type='text/css' href='../../assets/css/slick.min.css'>";
echo "<link rel='stylesheet' type='text/css' href='../../assets/css/slick-theme.css'>";
echo "<!--";
echo "";
echo "TemplateMo 559 Zay Shop";
echo "";
echo "https://templatemo.com/tm-559-zay-shop";
echo "";
echo "-->";
?>