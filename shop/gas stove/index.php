                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body"><B>
							<h1 id="product-title" class="h2">GADZO GLASS TOP 2B WITH SS FRAME -GZ HL GL 2B</h1></B>
							<p id="product-price" class="h3 py-2">₹ 3999</p>
                            <p class="py-2">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
											...
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="GADZO GLASS TOP 2B WITH SS FRAME -GZ HL GL 2B" data-price="3999">2 Burner</span>
											</li>
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="GADZO GLASS TOP 3B WITH SS FRAME -GZ HL GL 3B" data-price="4999">3 Burner</span>
