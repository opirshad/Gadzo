                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body"><B>
							<h1 id="product-title" class="h2">BIRIYANI POT 4 LITER</h1></B>
							<p id="product-price" class="h3 py-2">₹ 1499</p>
                            <p class="py-2">
                            ...
                            <h6>STAINLESS STEEL FOOD SERVER</h6>
                            <p>Premium Stainless Steel Hot Pot Locks in heat for hours! Perfect for home</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
											...
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="BIRIYANI POT 4 LITER" data-price="1499">4 L</span>
											</li>
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="BIRIYANI POT 8 LITER" data-price="3499">8 L</span>
											</li>
											<li class="list-inline-item">
