                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body"><B>
							<h1 id="product-title" class="h2">GADZO IRON BOX - GZBWIM1000</h1></B>
                            ...
                            <h6>GADZO IRON BOX - GZBWIM1000</h6>
                            <p>Premium Iorn Box for Perfect Outfit</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Avaliable Color :</h6>
                                </li>
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>Single Colour</strong></p>
                                </li>
                            </ul>
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>1000 watts</li>
                                <li>Adjustable Temprature Control</li>
