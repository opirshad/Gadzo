                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body"><B>
							<h1 id="product-title" class="h2">GADZO NON STICK PATHIRI TAWA  SQUARE 375X325 4.5MM -IGZPT SQ</h1></B>
                            ...
                            <h6>Gadzo Pathiri tawa</h6>
                            <p>Premium Pathiri Tawa! Perfect for home</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                            ...
                            <ul class="list-unstyled pb-3">
                                ...
                                <li>Triple layer coating</li>
                                <li>Firm and Stylish Handles/li>
                                <li>Gray Coating</li>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
											...
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="GADZO NON STICK PATHIRI TAWA  SQUARE 375X325 4.5MM -IGZPT SQ" data-price="1899">Square</span>
											</li>
											<li class="list-inline-item">
											  <span class="btn btn-success btn-size" data-title="GADZO NON STICK PATHIRI TAWA  ROUND 350MM, 4MM -IGZPT ROUND" data-price="1999">Round</span>
											</li>
